...
const BillSchema = new mongoose.Schema({
  ...
  accountId: { type: mongoose.Schema.Types.ObjectId, ref: "Account", required: true }, // Linked account
  ...
  frequency: { type: String, required: function () { return this.isRecurring; } }, // Required if recurring
  status: { type: String, enum: ["unpaid", "paid"], default: "unpaid" }, // Payment status
  transactionIds: [{ type: mongoose.Schema.Types.ObjectId, ref: "Transaction" }], // Array of transaction IDs
